...
function initMap() {
        ...
        geocoder.geocode({'address': 'New Jersey'}, function(results, status) {
          if (status === 'OK') {
...
function createCircles(){
	for (var statesID of seriesIDs) {
	 var cityCircle = new google.maps.Circle({
      ...
      fillOpacity: 0.35,
      map: map,
      center: DATASETS_API_SERIES_ID[statesID][1],
      radius: DATASETS_API_SERIES_ID[statesID][2][0][1]*500
    });
...
$(document).ready(function() {
	...
	$("#drawCircles").on("click", createCircles)
})
